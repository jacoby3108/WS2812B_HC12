...
#ifndef S12FTS32KV1_H			/*prevent duplicated includes */
#define S12FTS32KV1_H
...
typedef union uFPROT
  ...
  struct
    ...
    tU08 nv6		:1;		/*non-volatile flag bit */
